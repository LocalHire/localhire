...
class LendersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lender" do
    assert_difference('Lender.count') do
      post lenders_url, params: { lender: { phone: @lender.phone, user_id: @lender.user_id } }
    end
  ...
  test "should update lender" do
    patch lender_url(@lender), params: { lender: { phone: @lender.phone, user_id: @lender.user_id } }
